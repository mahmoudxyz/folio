  ...
  return (
    <div className="fade-in mt-10">
      ...
      <section className="container-wide mt-10 pt-24 sm:pt-32 pb-16 sm:pb-20 text-center">
        ...
        {/* Inline subscribe under search */}
        <div className="max-w-lg mx-auto mt-8">
          <p className="text-[12px] text-[var(--color-fg-faint)] mb-3">
            New issues every two weeks — subscribe to stay curious
          </p>
      ...
      {/* ═══════════════════════════════════════════════════
          SUBSCRIBE CTA
          ═══════════════════════════════════════════════════ */}
      <section className="container-wide mt-30 sm:mt-32 mb-4">
      ...
      {/* ═══════════════════════════════════════════════════
          OPEN SOURCE CTA
          ═══════════════════════════════════════════════════ */}
      <section className="container-wide mt-6 mb-8">
        <div className="rounded-2xl bg-[var(--color-bg-elevated)] border border-[var(--color-border)] p-8 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          <div className="max-w-md">
            <p className="section-label mb-3">Open Source</p>
            <p className="text-[14px] text-[var(--color-fg-muted)] leading-[1.75]">
              AI builds the site. Humans write the words. Every piece is written
              by someone who actually learned the thing.
            </p>
          </div>
          <a
            ...
            className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-[var(--color-fg)] text-[var(--color-bg)] text-[14px] font-medium hover:opacity-90 transition-opacity flex-shrink-0"
          >
